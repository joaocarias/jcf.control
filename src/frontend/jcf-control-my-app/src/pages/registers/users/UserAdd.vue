...
<div class="space-y-6">
    ...
    <div class="max-w-xl bg-white dark:bg-gray-800 rounded-lg shadow-lg p-6 border border-gray-200 dark:border-gray-700">
...
<form>
  ...
  <div class="mt-6 flex items-center justify-end gap-x-6">
    ...
    <button type="submit" class="rounded-md bg-indigo-500 px-3 py-2 text-sm font-semibold text-white hover:bg-indigo-500 focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-500">Save</button>
  </div>
</form>
...
const pageTitle = getTitle(RouteMeta.USER_ADD.name.toUpperCase())
const breadcrumb = getBreadcrumb(RouteMeta.USER_ADD.name.toUpperCase())


onMounted(async () => {
    try {
        roles.value = await RolesServices.getRoles()
    } catch {
